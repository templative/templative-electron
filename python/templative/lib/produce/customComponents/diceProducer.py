...
class DiceProducer(Producer):
    ...
    @staticmethod
    async def createComponentBackDataPieces(produceProperties:ProduceProperties, componentComposition:ComponentComposition, componentData:ComponentData, componentArtdata:ComponentArtdata, piecesDataBlob: [any], fontCache:FontCache):
