...
active-window-end   :  End execution in active window
active-window-start :  Start execution in active window
...
com.vaxxine.print.print-win32-vector:  Win32 Vector Print
com.vaxxine.print.print-win32-vector.noprefs:  Win32 Vector Print
...
duplicate-transform :  Duplicate selected objects and reapply last transformation
edit-remove-filter  :  Remove any filters from selected objects
effect.color-markers:  Color Markers
effect.color-markers.noprefs:  Color Markers
effect.distribute-along-path:  Distribute Along Path
effect.distribute-along-path.noprefs:  Distribute Along Path
effect.draw-from-triangle:  Construct from Triangle
effect.draw-from-triangle.noprefs:  Construct from Triangle
effect.extrude      :  Extrude Between Two Paths
effect.extrude.noprefs:  Extrude Between Two Paths
effect.interpolate  :  Interpolate Between Paths
effect.interpolate.noprefs:  Interpolate Between Paths
effect.long-shadow  :  Long Shadow
effect.long-shadow.noprefs:  Long Shadow
effect.merge-styles :  Merge Styles into CSS
effect.merge-styles.noprefs:  Merge Styles into CSS
effect.pattern-along-path:  Pattern along Path
effect.pattern-along-path.noprefs:  Pattern along Path
effect.voronoi      :  Voronoi Diagram
effect.voronoi-fill :  Voronoi Pattern Fill
effect.voronoi-fill.noprefs:  Voronoi Pattern Fill
effect.voronoi.noprefs:  Voronoi Diagram
element-a-open-link :  Add an anchor to an object.
element-image-crop  :  Remove parts of the image outside the applied clipping area.
...
file-rebase         :  Replace current document's contents by contents of another file
...
object-align-text   :  Align selected text anchors; usage: [[vertical | horizontal] [last|first|biggest|smallest|page|drawing|selection]?
object-distribute   :  Distribute selected objects; usage: [hgap | left | hcenter | right | vgap | top | vcenter | bottom]
object-distribute-text:  Distribute text anchors; usage [vertical | horizontal]
...
org.ekips.filter.flatten:  Approximate Curves by Straight Lines
org.ekips.filter.flatten.noprefs:  Approximate Curves by Straight Lines
...
org.ekips.filter.twirl:  Twirl
org.ekips.filter.twirl.noprefs:  Twirl
...
org.inkscape.effects.inset-shadow:  Inset Shadow
org.inkscape.effects.inset-shadow.noprefs:  Inset Shadow
...
org.inkscape.filter.dashit:  Convert Dashes to Path
org.inkscape.filter.dashit.noprefs:  Convert Dashes to Path
...
org.inkscape.path.envelope:  Envelope Deformation
org.inkscape.path.envelope.noprefs:  Envelope Deformation
...
org.inkscape.text.extract:  Extract from Selection
org.inkscape.text.extract.noprefs:  Extract from Selection
...
path-flatten        :  Flatten one or more overlapping objects into their visible parts
path-fracture       :  Fracture one or more overlapping objects into all possible segments
...
selection-empty-backup:  Empty stored backup of selection of objects or nodes
...
selection-restore-backup:  Restore backup of stored selection of objects or nodes
selection-set-backup:  Set backup of current selection of objects or nodes
...
swap-fill-and-stroke:  Swap fill and stroke of an object
system-data-directory:  Print system data directory and exit
text-convert-to-glyphs:  Convert text into individual glyphs
...
transform-reapply   :  Reapply the last transformation to the selection
...
window-crash        :  Force Inkscape to crash, useful for testing.
window-open         :  Open a window for the active document; GUI only
window-query-geometry:  Query the active window's location and size
window-set-geometry :  Set the active window's location and size (x, y, width, height)
