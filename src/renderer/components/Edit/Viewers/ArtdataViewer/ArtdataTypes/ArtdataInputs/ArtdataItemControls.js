    ...
    render() {
        return <React.Fragment>
            <button 
                ...
                className="btn btn-outline-primary artdata-crud-control artdata-up-arrow" 
                type="button" 
            ...
            <button 
                onClick={() => this.props.updateArtdataItemOrderCallback(this.props.index,this.props.index+1)} 
                className="btn btn-outline-primary artdata-crud-control" 
                type="button"
