    ...
    render() {
        return <div className="vertical-input-group editable-component">
            <div className={`input-group mb-3 input-group-sm mb-3`} data-bs-theme="dark">
                ...
                />
                <button onClick={this.props.duplicateComponentCallback} className="btn btn-outline-secondary trash-button" type="button" title={`Duplicate ${this.props.componentName}. This does not duplicate the files it uses.`}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-copy" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M4 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 5a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1h1v1a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1v1z"/>
                    </svg>
                </button>     
                <button onClick={() => this.props.deleteComponentCallback()} disabled={this.state.isProcessing} className="btn btn-outline-secondary trash-button" type="button" title={`Delete ${this.props.componentName}. This does not delete the files it uses.`}>
            ...
            <div className="input-group mb-3 input-group-sm mb-3" data-bs-theme="dark">
                ...
                />
                <span className="input-group-text no-right-border disabled-header" title={`Whether ${this.props.componentName} is rendered when we Render All components.`}>Disabled</span>
                <div className="input-group-text no-left-border">
                    ...
                    title={`Whether ${this.props.componentName} is rendered when we Render All components.`}
            ...
            <div className="input-group mb-3 input-group-sm mb-3" data-bs-theme="dark">
                <button onClick={async () => await this.props.openUnifiedComponentViewCallback(this.props.componentName)} className="btn btn-outline-secondary edit-component-button" type="button" title={`Edit all of ${this.props.componentName}'s files at once.`}>
                    ...
                    </svg> Edit {this.props.componentName} Composition
                </button>
                <button onClick={async ()=>{await this.renderComponent()}} disabled={this.state.isProcessing} className="btn btn-outline-secondary render-component-button" type="button" title={`Render ${this.props.componentName}.`}>
                    ...
                    </svg> Render {this.props.componentName} Composition
                </button>
