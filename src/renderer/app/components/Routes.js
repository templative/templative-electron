...
export const TOP_NAVBAR_ITEMS = [
    ...
    // },
    {
        name:"Create",
        route:"create",
        svg: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange" className="bi bi-file-plus-fill" viewBox="0 0 16 16">
    ...
    //     name:"Project",
    //     route:"project",
    //     svg: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange" className="bi bi-file-richtext-fill" viewBox="0 0 16 16">
    ...
    // },
    {
        name:"Edit",
        route:"edit",
        svg: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange" className="bi bi-file-text-fill" viewBox="0 0 24 24">
    ...
    },
    {
        name:"Rules",
        route:"rules",
        svg:<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange" className="bi bi-file-font-fill" viewBox="0 0 16 16">
  <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M5.057 4h5.886L11 6h-.5c-.18-1.096-.356-1.192-1.694-1.235l-.298-.01v6.09c0 .47.1.582.903.655v.5H6.59v-.5c.799-.073.898-.184.898-.654V4.755l-.293.01C5.856 4.808 5.68 4.905 5.5 6H5z"/>
    ...
    },
    {
        name:"Render",
        route:"render",
        svg: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange" className="bi bi-file-image-fill" viewBox="0 0 24 24">
    ...
    //     route:"map",
    //     svg:  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange" className="bi bi-globe-americas" viewBox="0 0 16 16">
    ...
    //     name:"Feedback",
    //     route:"feedback",
    //     svg: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange" className="bi bi-question-square-fill" viewBox="0 0 16 16">
