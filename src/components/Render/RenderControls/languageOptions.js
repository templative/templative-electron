var langaugeInfo = [
    ...
    { "name": "Chinese (Simplified)", "code": "zh-CN or zh (BCP-47)" },
    { "name": "Chinese (Traditional)", "code": "zh-TW (BCP-47)" },
